...
class Contato(models.Model):
    ...
    data_criacao = models.DateTimeField("data criacao contato", auto_now=True,)
    descricao = models.TextField("descricao contato",blank=True)
    categoria = models.ForeignKey("contatos.Categoria", verbose_name="categoria contato", on_delete=models.DO_NOTHING)
